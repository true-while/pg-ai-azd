...
/*********************************************************************************
Create zoodb_pub_sub database
    Do this for publisher and subscriber
*********************************************************************************/

DROP DATABASE IF EXISTS zoodb_pub_sub;

CREATE DATABASE zoodb_pub_sub;

SELECT current_database();


/*********************************************************************************
Create tables and foreign key contraints in zoodb_pub_sub
    Do this for publisher and subscriber
*********************************************************************************/
...
/*********************************************************************************
Populate the tables in zoodb_pub_sub
...
CREATE SUBSCRIPTION sub CONNECTION 'host=<your server>.postgres.database.azure.com user=pgAdmin dbname=zoodb_pub_sub password=<your pwd>' PUBLICATION pub;
